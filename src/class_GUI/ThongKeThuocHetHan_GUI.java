...
public class ThongKeThuocHetHan_GUI extends JFrame implements WindowListener {
	...
	private static JFreeChart createChart(CategoryDataset dataset) {
		JFreeChart barChart = ChartFactory.createBarChart3D("BIỂU ĐỒ THỐNG KÊ SỐ LƯỢNG THUỐC HẾT HẠN", "Loại thuốc",
				"Số lượng", dataset, PlotOrientation.VERTICAL, true, true, true);
	...
	private static CategoryDataset taoBieuDoBanDau() {
		...
		dataset.addValue(pnt_dao.laySoLuongThuocKeDonHetHan(), "Thuốc kê đơn", "Thuốc kê đơn");
		dataset.addValue(pnt_dao.laySoLuongThuocKhongKeDonHetHan(), "Thuốc không kê đơn", "Thuốc không kê đơn");
		dataset.addValue(pnt_dao.laySoLuongThucPhamChucNangHetHan(), "Thực phẩm chức năng", "Thực phẩm chức năng");
		dataset.addValue(pnt_dao.laySoLuongThucPhamChamSocSucKhoeHetHan(), "Chăm sóc sức khỏe", "Chăm sóc sức khỏe");
		return dataset;
	}
	...
	private static CategoryDataset sapXepThuocHetHanTangDan() {
		...
		danhSachThuocHetHan.add(new ThuocHetHan("Thuốc kê đơn", pnt_dao.laySoLuongThuocKeDonHetHan()));
		danhSachThuocHetHan.add(new ThuocHetHan("Thuốc không kê đơn", pnt_dao.laySoLuongThuocKhongKeDonHetHan()));
		danhSachThuocHetHan.add(new ThuocHetHan("Thực phẩm chức năng", pnt_dao.laySoLuongThucPhamChucNangHetHan()));
		danhSachThuocHetHan.add(new ThuocHetHan("Chăm sóc sức khỏe", pnt_dao.laySoLuongThucPhamChamSocSucKhoeHetHan()));
	...
	private static void taoBieuDoThongKe(CategoryDataset duLieuChoBieuDo) {
		...
		lblTitle.setIcon(new ImageIcon("data\\icons\\statistics-medicine-exprired.png"));
		lblTitle.setBounds(433, 23, 641, 82);
	 ...
	 * Create the frame.
	 */
	public ThongKeThuocHetHan_GUI(NhanVien nv) {
		emp = nv;
		getContentPane().setBackground(Color.WHITE);
		setBackground(Color.WHITE);
		setIconImage(Toolkit.getDefaultToolkit().getImage("data\\icons\\statistics-chart-1.png"));
		// menuBar
		...
		String[] option = "Mặc định;Sắp xếp tăng dần;Sắp xếp giảm dần".split(";");
		JLabel lblChonKieuSapXep = new JLabel("Chọn kiểu sắp xếp:");
		...
		cbLoaiBieuDo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (loaiSapXep.equalsIgnoreCase("Sắp xếp tăng dần"))
					taoBieuDoThongKe(sapXepThuocHetHanTangDan());
				else if (loaiSapXep.equalsIgnoreCase("Sắp xếp giảm dần"))
		...
		JButton btnXemDanhSachThuocHetHan = new JButton("Xem danh sách thuốc hết hạn");
		btnXemDanhSachThuocHetHan.setBackground(Color.WHITE);
		btnXemDanhSachThuocHetHan.setIcon(new ImageIcon("data\\icons\\icons8-pill-24.png"));
		btnXemDanhSachThuocHetHan.setFocusable(false);
		panel.add(btnXemDanhSachThuocHetHan);
		btnXemDanhSachThuocHetHan.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				XemDanhSachPhieuNhapThuocHetHan_GUI xemDanhSachPhieuNhapThuocHetHan = new XemDanhSachPhieuNhapThuocHetHan_GUI(
						emp);
				xemDanhSachPhieuNhapThuocHetHan.setVisible(true);
			}
		});
		...
		setTitle("Thống kê thuốc hết hạn");
