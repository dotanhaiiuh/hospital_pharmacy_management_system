...
public class ThongKeThuocTonKho_GUI extends JFrame implements WindowListener {
	...
	private static JFreeChart createChart(CategoryDataset dataset) {
		JFreeChart barChart = ChartFactory.createBarChart3D("BIỂU ĐỒ THỐNG KÊ SỐ LƯỢNG THUỐC TỒN KHO", "Loại thuốc",
	...
	private static CategoryDataset taoBieuDoBanDau() {
		...
		dataset.addValue(thuoc_dao.laySoLuongThuocKeDonConTonKho(), "Thuốc kê đơn", "Thuốc kê đơn");
		dataset.addValue(thuoc_dao.laySoLuongThuocKhongKeDonConTonKho(), "Thuốc không kê đơn", "Thuốc không kê đơn");
		dataset.addValue(thuoc_dao.laySoLuongThucPhamChucNangConTonKho(), "Thực phẩm chức năng", "Thực phẩm chức năng");
		dataset.addValue(thuoc_dao.laySoLuongThucPhamChamSocSucKhoeConTonKho(), "Chăm sóc sức khỏe", "Chăm sóc sức khỏe");
		return dataset;
	}
	...
	private static CategoryDataset sapXepThuocHetHanTangDan() {
		...
		danhSachThuocHetHan.add(new ThuocHetHan("Thuốc kê đơn", thuoc_dao.laySoLuongThuocKeDonConTonKho()));
		danhSachThuocHetHan.add(new ThuocHetHan("Thuốc không kê đơn", thuoc_dao.laySoLuongThuocKhongKeDonConTonKho()));
		danhSachThuocHetHan.add(new ThuocHetHan("Thực phẩm chức năng", thuoc_dao.laySoLuongThucPhamChucNangConTonKho()));
		danhSachThuocHetHan.add(new ThuocHetHan("Chăm sóc sức khỏe", thuoc_dao.laySoLuongThucPhamChamSocSucKhoeConTonKho()));
	...
	public ThongKeThuocTonKho_GUI(NhanVien nv) {
		...
		JButton btnXemDanhSachThuocTonKho = new JButton("Xem danh sách thuốc tồn kho");
		...
		setTitle("Thống kê thuốc tồn kho");
