...
public class TimThongTinNhanVien_GUI extends JFrame implements WindowListener, ActionListener, ListSelectionListener {
	 ...
	 * Create the frame.
	 */
	public TimThongTinNhanVien_GUI(NhanVien nv, String tenChucNangDaChon) {
		emp = nv;
		...
		btnXemChiTiet.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int row = tableNhanVien.getSelectedRow();
				if (row != -1) {
					if (tenChucNangCanThucHienKhiTimKiem.equalsIgnoreCase("Sửa thông tin nhân viên")) {
						SuaThongTinNhanVien_GUI suaThongTinNhanVien = new SuaThongTinNhanVien_GUI(taoNhanVien(), emp,
								getTitle());
						suaThongTinNhanVien.setVisible(true);
					} else if (tenChucNangCanThucHienKhiTimKiem.equalsIgnoreCase("Xóa thông tin nhân viên")) {
						XoaThongTinNhanVien_GUI xoaThongTinNhanVien = new XoaThongTinNhanVien_GUI(taoNhanVien(), emp,
								false);
		...
		lblTitle.setIcon(new ImageIcon("data\\icons\\search-employee-title.png"));
		lblTitle.setBounds(428, 10, 740, 89);
		...
		lblThongTinNhanVien.setBounds(20, 22, 1472, 35);
		...
		lblMaNhanVien.setBounds(10, 68, 114, 26);
		...
		lblNgayVaoLam.setBounds(10, 114, 114, 26);
		...
		datePickerNgayVaoLam.setBounds(129, 114, 549, 27);
		...
		cbMaNhanVien.setBounds(129, 67, 549, 29);
		...
		lblSoDienThoai.setBounds(10, 202, 114, 26);
		...
		cbSoDienThoai.setBounds(129, 201, 549, 29);
