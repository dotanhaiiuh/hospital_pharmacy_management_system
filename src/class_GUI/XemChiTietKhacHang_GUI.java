...
public class XemChiTietKhacHang_GUI extends JFrame implements WindowListener, ListSelectionListener {
	 ...
	 * Create the frame.
	 */
	public XemChiTietKhacHang_GUI(KhachHang khachHangCanXem, NhanVien nhanVienXem) {
		emp = nhanVienXem;
		khachHang = khachHangCanXem;
		...
		lblTitle.setIcon(new ImageIcon("data\\icons\\customer-title.png"));
		lblTitle.setBounds(409, 10, 719, 89);
