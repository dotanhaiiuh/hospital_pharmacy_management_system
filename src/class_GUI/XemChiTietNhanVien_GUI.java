...
public class XemChiTietNhanVien_GUI extends JFrame implements WindowListener, ListSelectionListener {
	 ...
	 * Create the frame.
	 */
	public XemChiTietNhanVien_GUI(NhanVien nhanVienCanXem, NhanVien nhanVienXem) {
		emp = nhanVienXem;
		nhanVien = nhanVienCanXem;
		...
		lblTitle.setIcon(new ImageIcon("data\\icons\\employee-title.png"));
		lblTitle.setBounds(433, 10, 666, 89);
		...
		btnThemAnh = new JButton("Ảnh đại diện");
		...
		JButton btnCapNhatThongTinDangNhap = new JButton("Thông tin đăng nhập hệ thống");
		btnCapNhatThongTinDangNhap.setForeground(Color.RED);
		btnCapNhatThongTinDangNhap.setBackground(Color.YELLOW);
		...
		setTitle("Xem thông tin chi tiết về nhân viên");
