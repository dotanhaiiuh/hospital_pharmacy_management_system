...
public class XemChiTietPhieuNhapThuoc_GUI extends JFrame implements WindowListener {
	 ...
	 * Create the frame.
	 */
	public XemChiTietPhieuNhapThuoc_GUI(PhieuNhapThuoc p, NhanVien e) {
		phieuNhapThuoc = p;
		emp = e;
		...
		lblTitle.setIcon(new ImageIcon("data\\icons\\import-medicine-title.png"));
		lblTitle.setBounds(472, 10, 548, 93);
		...
		setTitle("Xem chi tiết phiếu nhập thuốc");
