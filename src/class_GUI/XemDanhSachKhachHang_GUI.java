...
public class XemDanhSachKhachHang_GUI extends JFrame implements WindowListener, ActionListener, ListSelectionListener {
	 ...
	 * Create the frame.
	 */
	public XemDanhSachKhachHang_GUI(NhanVien nv) {
		emp = nv;
		getContentPane().setBackground(Color.WHITE);
		setBackground(Color.WHITE);
		setIconImage(Toolkit.getDefaultToolkit().getImage("data\\icons\\list-customer.png"));
		// menuBar
		...
		btnXemChiTiet.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int row = tableKhachHang.getSelectedRow();
				if (row != -1) {
					XemChiTietKhacHang_GUI xemChiTietKhacHang = new XemChiTietKhacHang_GUI(taoKhachHang(), emp);
					xemChiTietKhacHang.setVisible(true);
				} else {
		...
		lblTitle.setIcon(new ImageIcon("data\\icons\\list-customer-title.png"));
		...
		datePickerNgayDangKy.setBounds(150, 114, 528, 27);
		...
		cbSoDienThoai.setBounds(150, 157, 528, 29);
		...
		cbMaKhachHang.setBounds(147, 67, 531, 29);
		...
		cbDiaChiKhachHang.setBounds(150, 199, 1301, 29);
		...
		setTitle("Xem danh sách khách hàng");
