...
public class XemDanhSachNhaCungCap_GUI extends JFrame implements ActionListener, WindowListener, ListSelectionListener {
	 ...
	 * Create the frame.
	 */
	public XemDanhSachNhaCungCap_GUI(NhanVien e) {
		emp = e;
		...
		lblTitle.setIcon(new ImageIcon("data\\icons\\list-supplier-title.png"));
		lblTitle.setBounds(407, 10, 950, 93);
		...
		cbMaNCC.setBounds(146, 61, 545, 29);
		panel_3.add(cbMaNCC);
		...
		lblMaNhaCungCap.setBounds(10, 61, 135, 26);
		...
		btnSearchMaNCC.setBounds(693, 60, 31, 31);
		...
		lblSoDienThoai.setBounds(10, 100, 135, 26);
		...
		cbSoDienThoai.setBounds(146, 100, 545, 29);
		...
		btnSearchSoDienThoai.setBounds(693, 99, 31, 31);
