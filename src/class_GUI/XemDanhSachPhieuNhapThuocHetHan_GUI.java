...
public class XemDanhSachPhieuNhapThuocHetHan_GUI extends JFrame
	...
	public XemDanhSachPhieuNhapThuocHetHan_GUI(NhanVien e) {
		...
		btnXemChiTiet = new JButton("Xem chi tiết phiếu nhập thuốc hết hạn");
		...
		setTitle("Xem danh sách thuốc hết hạn");
		...
		if (danhSachTatCaPhieuNhapThuocHetHan != null) {
			...
			Toolkit.getDefaultToolkit().beep();
			JOptionPane.showMessageDialog(null, "Chưa có phiếu nhập thuốc hay thuốc nào hết hạn", "Thông báo",
