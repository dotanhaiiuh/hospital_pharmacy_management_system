...
public class XemDanhSachPhieuNhapThuoc_GUI extends JFrame
	 ...
	 * Create the frame.
	 */
	public XemDanhSachPhieuNhapThuoc_GUI(NhanVien e) {
		emp = e;
		...
		lblTitle.setIcon(new ImageIcon("data\\icons\\list-import-medicine-title.png"));
		lblTitle.setBounds(426, 10, 711, 93);
		...
		cbMaPhieuNhap.setBounds(152, 60, 570, 29);
		...
		datePickerNgaySanXuat.setBounds(152, 105, 570, 29);
		...
		cbMaThuoc.setBounds(152, 148, 570, 29);
		...
		cbMaNhaCungCap.setBounds(152, 190, 570, 29);
		...
		cbDonViThuoc.setBounds(152, 232, 570, 29);
		...
		setTitle("Xem danh sách nhập thuốc");
